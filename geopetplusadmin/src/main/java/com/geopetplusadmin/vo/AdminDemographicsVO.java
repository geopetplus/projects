...
public class AdminDemographicsVO implements Serializable {
	...
	public AdminDemographicsVO(){}

	public AdminDemographicsVO(String adminid, String adminLastName, 
			String adminFirstName, String mailAddr1,
			String mailAddr2, String mailingLocation, String mailingCity,
			String mailingState, String mailingPincode,  String adminPhone,
			String  adminAlternativeContact, String adminMobileNum,
			String adminEmail,
		...
		this.adminAltContact =  adminAlternativeContact;
	...
	public String toString() {
		return "AdminDemographics [adminid=" + adminid
				...
				+ ", adminPhone=" + adminPhone + ", adminAlternativeContact="
