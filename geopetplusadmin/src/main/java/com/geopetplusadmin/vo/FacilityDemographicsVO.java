...
public class FacilityDemographicsVO implements Serializable {
	...
	public FacilityDemographicsVO(){}

	public FacilityDemographicsVO(String facilityid, String facilityname, String contactLastName,
	...
	public String toString() {
		return "FacilityDemographicsVO [facilityid=" + facilityid + ", facilityname=" + facilityname
